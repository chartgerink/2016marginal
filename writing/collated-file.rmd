...
_Note_. NA-values correspond to numbers that cannot be calculated using the dataset provided by @10.1177/0956797616645672 [osf.io/92xqk]. ^a^Percent of _p_-values $.05 < p \leq.1%$ reported as marginally significant. ^b^Percent of articles containing at least one 'marginally significant' result.
