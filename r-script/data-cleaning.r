...
all.meta$journal <- gsub("Canadian Journal of Psychology/Revue canadienne de psychologie", "Canadian Journal of Experimental Psychology", all.meta$journal)
all.meta$journal <- gsub("Canadian Journal of Experimental Psychology/Revue canadienne de psychologie exp̩rimentale", "Canadian Journal of Experimental Psychology", all.meta$journal)
all.meta$journal <- gsub("Canadian Journal of Psychology/Revue canadienne de psychologie", "Canadian Journal of Experimental Psychology", all.meta$journal)
all.meta$journal <- gsub("Canadian Journal of Psychology Revue Canadienne de Psychologie", "Canadian Journal of Experimental Psychology", all.meta$journal)
all.meta$journal <- gsub("Canadian Journal of Experimental Psychology/Revue canadienne de psychologie exp̩rimentale", "Canadian Journal of Experimental Psychology", all.meta$journal)
